    ...
    <div class="hide-on-small">
      ...
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper" v-if="!isLogin">
          ...
          <el-button type="primary" @click="clickLogin">로그인<el-icon><Key /></el-icon></el-button>
        </div>
        <div class="button-wrapper" v-if="isLogin">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const isLogin = computed(()=>{
      const IsLogin = store.getters['accountStore/getToken']
    ...
    return { state, menuSelect, clickLogo, clickLogin, changeCollapse,isLogin,clickLogout,clickSignUp,Key }
