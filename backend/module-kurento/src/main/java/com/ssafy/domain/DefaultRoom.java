 ...
 */
@Getter
public class DefaultRoom implements Closeable {
  ...
  public DefaultRoom(String roomName, String debateId, MediaPipeline pipeline) {
  ...
  public void close() {
    ...
    pipeline.release(new Continuation<Void>() {
      ...
      public void onSuccess(Void result) throws Exception {
        log.trace("ROOM {}: Released Pipeline", DefaultRoom.this.roomName);
      }

      @Override
      public void onError(Throwable cause) throws Exception {
        log.warn("PARTICIPANT {}: Could not release Pipeline", DefaultRoom.this.roomName);
      }
    });
