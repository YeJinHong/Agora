    ...
    public MailDto makeLinkMail(UserEmailReq userEmailReq) throws MessagingException {
        MailDto mailDto = MailDto.builder()
                ...
                .content("<div>\n" +
                        ...
                        "      <p style=\"font-size: 14px; line-height: 140%; margin: 0px;\"><span style=\"font-size: 16px; line-height: 22.4px;\">안녕하세요, Agora 고객님.</span></p>\n" +
                        "  <p style=\"font-size: 14px; line-height: 140%; margin: 0px;\"><span style=\"font-size: 16px; line-height: 22.4px;\">요청하신 임시비밀번호를 알려드립니다.</span></p>\n" +
                        ...
                        "      <p style=\"font-size: 14px; line-height: 140%; margin: 0px;\"><span style=\"font-size: 16px; line-height: 22.4px;\">임시비밀번호</span></p>\n" +
                        ...
                        "      <a href=\"https://www.링크.com\" target=\"_blank\" style=\"box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #ff6905; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; :auto; max-:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;\" rel=\"noreferrer noopener\">\n" +
                        "        <span style=\"display:block;padding:10px 16px;line-height:120%;\"><strong><span style=\"font-size: 16px; line-height: 19.2px;\">Agora 웹사이트 바로가기 &gt;</span></strong></span>\n" +
                        "      </a>\n" +
                        "  </div>\n" +
                        "  \n" +
                        "        </td></tr></tbody>\n" +
