                    ...
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="title instructor-text"><router-link to="course-details">Information About UI/UX Design Degree</router-link></h3>
                            ...
                            <div class="product-content">
                                <div class="course-group d-flex">
                                    <div class="course-group-img d-flex">
                                        ...
                                        <div class="course-name">
                                            <h4><router-link to="instructor-profile">Jenis R.</router-link></h4>
                                            <p>Instructor</p>
                                        </div>
                                    </div>
                                    <div class="course-share d-flex align-items-center justify-content-center">
                                ...
                                <h3 class="title instructor-text"><router-link to="course-details">Wordpress for Beginners - Master Wordpress Quickly</router-link></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="../../../assets/img/icon/icon-01.svg" alt="">
                                        <p>11+ Lesson</p>
                    ...
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="title instructor-text"><router-link to="course-details">Sketch from A to Z (2022): Become an app designer</router-link></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="../../../assets/img/icon/icon-01.svg" alt="">
                                        <p>16+ Lesson</p>
                    ...
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="title instructor-text"><router-link to="course-details">Learn Angular Fundamentals From beginning to advance lavel</router-link></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="../../../assets/img/icon/icon-01.svg" alt="">
                                        <p>10+ Lesson</p>
                    ...
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="title instructor-text"><router-link to="course-details">Build Responsive Real World Websites with HTML5 and CSS3</router-link></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="../../../assets/img/icon/icon-01.svg" alt="">
                                        <p>13+ Lesson</p>
                    ...
                    <div class="course-box d-flex aos" data-aos="fade-up">
                        <div class="product">
                            ...
                            <div class="product-content">
                                ...
                                <h3 class="title instructor-text"><router-link to="course-details">C# Developers Double Your Coding Speed with Visual Studio</router-link></h3>
                                <div class="course-info d-flex align-items-center">
                                    <div class="rating-img d-flex align-items-center">
                                        <img src="../../../assets/img/icon/icon-01.svg" alt="">
                                        <p>7+ Lesson</p>
