							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box instruct-grid flex-fill">
										<div class="instructor-img">
											<router-link to="instructor-profile">
												<img class="img-fluid" alt="" src="../../../assets/img/user/user1.jpg">
                                            </router-link>
											<a href="javascript:;" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box instruct-grid flex-fill">
										<div class="instructor-img">
											<router-link to="instructor-profile">
												<img class="img-fluid" alt="" src="../../../assets/img/user/user13.jpg">
                                            </router-link>
											<a href="javascript:;" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
											<h5><router-link to="instructor-profile">Monroe Parker</router-link></h5>
											<h6>Instructor</h6>
											<div class="rating-img d-flex align-items-center justify-content-center">
												<img src="../../../assets/img/icon/icon-01.svg" class="me-1" alt="">
												<p>12+ Lesson</p>
