                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="personal-form">
                                    <h4>Your Are Done!</h4>
                                    <div class="your-done">
                                        <p>If you need more info, please <router-link to="login">Sign In.</router-link></p>
                                        <p>Writing headlines for blog posts is as much an art as it is a science and probably warrants its own post, but for all advise is with what works for your great & amazing audience.</p>
                                    </div>
                                    <div class="btn-group work-done d-flex">
                                        <div class="back-btn">
                                            <router-link to="register-step-three" class="btn btn-back">back</router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
