											...
											<div class="row">
												...
												<div class="col-lg-4">
													<div class="form-group">
                                                        ...
                                                        <vue-select :options="State" placeholder="Select State"  name="sellist1" />
													</div>
												</div>
												<div class="col-lg-4">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-lg-4">
													<div class="form-group">
                                                        ...
                                                        <vue-select :options="Month" placeholder="Month"  name="sellist1" />
													</div>
												</div>
												<div class="col-lg-4">
													<div class="form-group">
														<label  class="form-label">Year</label>
                                                        <vue-select :options="Year" placeholder="Year"  name="sellist1" />
													</div>
												</div>
												<div class="col-lg-4">
													<div class="form-group">
												...
												<div class="col-md-12 col-lg-10">
													<div class="form-group ship-check">
														<input class="form-check-input" type="checkbox" name="remember"> Remember this card
													</div>
												</div>
								...
								<div class="student-widget select-plan-group">
									<div class="student-widget-group">
										...
										<div class="plan-change">
											<router-link to="pricing-plan" class="btn btn-primary">Change the Plan</router-link>
										</div>
									</div>
								</div>
							</div>
