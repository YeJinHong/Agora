                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter your website url">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="sel1" class="form-label">Country</label>
                                                    <vue-select :option="country" placeholder="Select country" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-check form-switch check-on">
                                                    ...
                                                    <label class="form-check-label" for="flexSwitchCheckChecked">Use same address for Billing.</label>
                                                </div>
                                                <div class="next-btn">
