                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <vue-select :options="Select" placeholder="Select" name="sellist1" id="sel1" />
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-check form-switch check-on">
                                                    ...
                                                    <label class="form-check-label" >Show courses you're taking on your profile page</label>
                                                </div>
                                                <div class="form-check form-switch check-on">
                                                    <input class="form-check-input" type="checkbox" >
                                                ...
                                                <div class="btn-group d-flex">
                                                    <div class="back-btn">
                                                        <router-link to="register-step-two" class="btn btn-back" >back</router-link>
                                                    </div>
                                                    <div class="next-btn">
