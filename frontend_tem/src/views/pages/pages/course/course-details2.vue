						...
						<div class="col-lg-12">
							...
							<div class="mb-4">
								<a href="https://www.youtube.com/embed/1trvO6dqQUI" class="video-thumbnail" data-fancybox="">
									...
									<img class="img-fluid" src="https://i8c205.p.ssafy.io:8082/api/v1/debates/15" alt="">
								</a>
							</div>
							
							<!-- Course -->
							<div class="card com-course">
								<div class="row g-0">
									<div class="col-lg-8 br-1 bb-1">
									...
									<div class="col-lg-4 bb-1">
										<div class="no-video">
											<div class="card-body video-details">
												...
												<div class="row gx-1">
													<div class="col-sm-6">
														<router-link to="course-wishlist" class="btn btn-wish w-100"><i class="feather-heart"></i> Add to Wishlist</router-link>
													</div>
													<div class="col-sm-6">
														<a href="javascript:;" class="btn btn-wish w-100"><i class="feather-share-2"></i> Share</a>
													</div>
													<div class="col-sm-6">
														<router-link to="cart" class="btn btn-cart w-100">Add To Cart</router-link>	
													</div>
													<div class="col-sm-6">
														<router-link to="checkout" class="btn btn-enroll w-100">Buy Now</router-link>	
													</div>
												</div>
											</div>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 br-1">
										<div class="card-body include-sec">
										<h5 class="subs-title text-black">Includes</h5>
										<div class="row">
										<div class="col-lg-6">
											<ul>
									...
									<div class="col-lg-6 col-md-6">
										<div class="card-body feature-sec">
											<h5 class="subs-title text-black">Course Features</h5>
											<div class="row">
											<div class="col-lg-6">
												<ul>
							...
							<!-- Overview -->
							<div class="card overview-sec" id="Overview">
								<div class="card-body">
							...
							<!-- Course Content -->
							<div class="card content-sec" id="Course_Content">
								<div class="card-body">
									<div class="row">
										<div class="col-sm-6">
							...
							<!-- Instructor -->
							<div class="card instructor-sec" id="Instructor">
								<div class="card-body">
							...
							<!-- Comment -->
							<div class="card comment-sec m-0">
								<div class="card-body">
