                            ...
                            <div class="col-lg-7">
                                <div class="personal-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="world-img">
                                                <img src="../../../assets/img/net-icon-03.png" class="img-fluid" alt="Logo">
                                            </div>
                                        </div>
                                        <div class="col-lg-10">
                                            <div class="google-account">
                                        ...
                                        <div class="col-auto">
                                            <div class="world-img">
                                                <img src="../../../assets/img/net-icon-04.png" class="img-fluid" alt="Logo">
                                            </div>
                                        </div>
                                        <div class="col-lg-10">
                                            <div class="google-account">
                                        ...
                                        <div class="btn-group account-btn d-flex">
                                            ...
                                            <div class="next-btn">
                                                <router-link to="register-step-five" class="btn btn-primary btn-start" >Next</router-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
