                                ...
                                <div class="col-lg-12" v-for="team in debate_info.pannel">
                                    ...
                                    <div class="radio-with-img p-2">
                                        ...
                                        <div class = "radio-wrapper text-center">
                                            <p class="radio-deposit-item" v-for= "(member, index) in team.evaluatedList" :key="index" :id = "'evaluated_userEmail_'+member.userEmail">
                                                <input type="radio" name="evaluated_id" :id="'deposit-type-'+index" :value="member.userEmail" class="ng-valid ng-dirty ng-touched ng-empty" aria-invalid="false" v-model="evaluated_id">
                                    ...
                                    <div class="form-group mb-0" v-for=" member in team.evaluatedList">
                                        ...
                                        <div class="from-group" v-for="division1 in questions.children" v-show ="evaluated_id == member.userEmail">
                                            <div>
