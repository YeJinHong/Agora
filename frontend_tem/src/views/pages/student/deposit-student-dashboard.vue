											...
											<div class="card-body">
												<div class="view-all-grp d-flex">
													<div class="student-ticket-view">
														...
														<router-link to="purchase-history" >View All</router-link>
													</div>
											...
											<div class="card-body">
												<div class="view-all-grp d-flex">
													<div class="student-ticket-view">
														...
														<router-link to="deposit-student" >View All</router-link>
													</div>
													<div class="img-deposit-ticket">
											...
											<div class="card-body">
												<div class="view-all-grp d-flex">
													<div class="student-ticket-view">
														<h3>20</h3>
														<p>Total Deposit</p>
														<router-link to="transactions-student" >View All</router-link>
													</div>
													<div class="img-deposit-ticket">
