											...
											<div class="course-box course-design d-flex " >
												<div class="product">
													...
													<div class="product-content">
														...
														<h3 class="title product-content-title"><router-link to="course-details">Information About UI/UX Design Degree</router-link></h3>
											...
											<div class="course-box course-design d-flex " >
												<div class="product">
													...
													<div class="product-content">
														...
														<h3 class="title product-content-title"><router-link to="course-details">Wordpress for Beginners - Master Wordpress Quickly</router-link></h3>
														<div class="course-info d-flex align-items-center border-0 m-0">
															<div class="rating-img d-flex align-items-center">
																<img src="../../../assets/img/icon/icon-01.svg" alt="">
																<p>12+ Lesson</p>
